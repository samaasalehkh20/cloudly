...
@section('page_name', 'Dashboard Page')
            ...
            <div class="col-xl-3">
                ...
                <div class="card card-custom bg-light-danger card-stretch gutter-b">
                    ...
                    <div class="card-body">
                        ...
                        <span class="font-weight-bold text-muted font-size-sm">Hit</span>
                    </div>
                    <!--end::Body-->
                </div>
                <!--end::Stats Widget 26-->
            ...
            <div class="col-xl-3">
                ...
                <div class="card card-custom bg-light-warning card-stretch gutter-b">
                    ...
                    <div class="card-body">
                        ...
                        <span class="font-weight-bold text-muted font-size-sm">Size</span>
                    </div>
                    <!--end::Body-->
                </div>
                <!--end::Stat: Widget 28-->
