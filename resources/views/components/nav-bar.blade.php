...
<ul class="menu-nav">
    ...
    <li class="menu-item" aria-haspopup="true">
        <a href="{{ route('upload_image.create') }}"
           class="menu-link">
            <span class="svg-icon menu-icon">
               <i class="las la-cloud-upload-alt" style="font-size: 24px"></i>
            </span>
    ...
    <li class="menu-item" aria-haspopup="true">
        <a href="{{ route('all_keys.index') }}"
           class="menu-link">
            <span class="svg-icon menu-icon">
                <i class="las la-layer-group" style="font-size: 24px"></i>
            </span>
            <span class="menu-text">All Keys</span>
        </a>
    </li>
    ...
    <li class="menu-item" aria-haspopup="true">
        <a href="{{ route('recent.index') }}"
           class="menu-link">
            ...
            <span class="menu-text">Recent Used</span>
        </a>
    </li>
